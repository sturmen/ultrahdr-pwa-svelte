    ...
    (function() {
      ...
      that.remove = function(jpeg) {
        ...
        var newSegments = segments.filter(function(seg) {
          return !(seg.slice(0, 2) == "؇" && seg.slice(4, 10) == "Exif\0\0");
        });
      ...
      that.insert = function(exif, jpeg) {
        ...
        var exifStr = "؇" + pack(">H", [exif.length + 2]) + exif;
        var segments = splitIntoSegments(jpeg);
      ...
      function _get_thumbnail(jpeg) {
        var segments = splitIntoSegments(jpeg);
        while ("؈" <= segments[1].slice(0, 2) && segments[1].slice(0, 2) <= "ؕ") {
      ...
      function getExifSeg(segments) {
        ...
        for (var i = 0; i < segments.length; i++) {
          seg = segments[i];
          if (seg.slice(0, 2) == "؇" && seg.slice(4, 10) == "Exif\0\0") {
            return seg;
          }
        }
        return null;
      ...
      function mergeSegments(segments, exif) {
        ...
        segments.forEach(function(segment, i) {
          if (segment.slice(0, 2) == "؇" && segment.slice(4, 10) == "Exif\0\0") {
            if (!hasExifSegment) {
              segments[i] = exif;
              hasExifSegment = true;
            } else {
...
export default require_piexif();
//# sourceMappingURL=piexifjs.js.map
